...
const projectsData = [
  ...
  },
  {
    ...
    description: "Built an interactive JavaScript game featuring real-time score tracking, game logic implementation, and responsive user interactions.",
    image: assets.rock,
    tag: ["All", "Web"],
    gitUrl: "https://github.com/AyeshaAfzal-01/rock-paper-scissors-game",
    previewUrl: "",
  },
  {
    id: 6,
    title: "X.com (Twitter) Clone",
    description: "X.com clone with Express.js",
  ...
  },
  {
    id: 7,
    title: "Netflix Clone",
    description: "Netflix clone with javascript",
  ...
  },
  {
    ...
    description: "Game developed using JavaScript",
    image: assets.tictac,
    tag: ["All"],
    gitUrl: "/",
    previewUrl: "",
...
const Work = () => {
  ...
  return (
    <section id="work">
      <h2 className="text-center text-5xl mt-20 mb-4 font-bold text-dark font-display dark:text-white">My <span className="text-primary">P</span>rojects</h2>

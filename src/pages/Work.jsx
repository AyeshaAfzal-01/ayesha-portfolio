...
const Work = () => {
  ...
  return (
    <section id="work" className="scroll-mt-20">
      <h2 className="text-center text-4xl md:text-5xl mt-15 md:mt-20 mb-2 font-bold text-dark font-display dark:text-white">My <span className="text-primary">P</span>rojects</h2>

...
const ProjectCard = ({ imgUrl, title, description, gitUrl, previewUrl }) => {
  return (
    <div className="border-2 border-gray-100 dark:border-none rounded-xl">
      ...
      >
        <div className="overlay flex items-center justify-center absolute top-0 left-0 w-full h-full bg-[#181818] rounded-xl opacity-0 hidden group-hover:flex group-hover:opacity-80 transition-all duration-500">
...
>
  <FaEye className="h-8 w-8 text-[#ADB7BE] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 cursor-pointer group-hover/link:text-white" />
      ...
      <div className="text-dark dark:text-white font-body tracking-tight leading-6 rounded-b-xl bg-offwhite py-8 px-6 text-justify dark:bg-dark-gray">
